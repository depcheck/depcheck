...
export default [
  ...
  },
  {
    ...
    expected: {
      ...
      devDependencies: [],
      missing: {
        '@my-namespace/lib': ['unused.ts'],
        '@my-namespace/lib2': ['unused.ts'],
        '@my-namespace/lib3': ['unused.ts'],
        '@my-namespace/lib4': ['unused.ts'],
        '@my-namespace/lib5': ['unused.ts'],
        '@my-namespace/lib6': ['unused.ts'],
        'function-import': ['unused.ts'],
        'import-with-from': ['unused.ts'],
        'require-from': ['unused.ts'],
      },
      using: {
        react: ['component.tsx'],
        'ts-dep-1': ['index.ts'],
