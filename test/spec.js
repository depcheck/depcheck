  ...
  },
  {
    ...
    expected: {
      ...
      missing: {
        ...
        'another-module-01': ['index.js', 'index.ts'],
        'another-module-11': ['index.js', 'index.ts'],
      },
      using: {
        'another-loader': ['index.js'],
        'script-loader': ['index.js', 'index.ts'],
        ...
        'css-loader-01': ['index.js', 'index.ts'],
        'css-loader-02': ['index.js', 'index.ts'],
        'css-loader-03': ['index.js', 'index.ts'],
        'css-loader-04': ['index.js', 'index.ts'],
        'style-loader-01': ['index.js', 'index.ts'],
        'style-loader-02': ['index.js', 'index.ts'],
        'style-loader-03': ['index.js', 'index.ts'],
        'style-loader-04': ['index.js', 'index.ts'],
        'imports-loader-01': ['index.js', 'index.ts'],
        'imports-loader-02': ['index.js', 'index.ts'],
        'css-loader-11': ['index.js', 'index.ts'],
        'css-loader-12': ['index.js', 'index.ts'],
        'css-loader-13': ['index.js', 'index.ts'],
        'css-loader-14': ['index.js', 'index.ts'],
        'style-loader-11': ['index.js', 'index.ts'],
        'style-loader-12': ['index.js', 'index.ts'],
        'style-loader-13': ['index.js', 'index.ts'],
        'style-loader-14': ['index.js', 'index.ts'],
        'imports-loader-11': ['index.js', 'index.ts'],
        'imports-loader-12': ['index.js', 'index.ts'],
      },
    },
    expectedErrorCode: -1,
  },
